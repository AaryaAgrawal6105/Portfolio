...
import { Github, Linkedin, Mail, Download, ArrowUp, Menu, X, CheckCircle2, Send, ExternalLink } from 'lucide-react';
import portfolio from './assets/Porfolio_Image.jpg';
...
const Portfolio = () => {
  ...
  const handleResumeDownload = () => {
    ...
    link.href = 'data:application/pdf;base64,';
  ...
  const Badge = ({ children }) => (
    <span className="bg-sky-500/10 text-sky-300 text-sm font-medium px-3 py-1.5 rounded-full border border-sky-500/20">
      {children}
    </span>
  );
  ...
  const SectionHeader = ({ title }) => (
    <div className="text-center mb-20">
      ...
      <div className="w-24 h-1.5 bg-sky-500 mx-auto rounded-full mt-6" />
    </div>
  );

  // Tech stack with simple colored divs instead of complex SVGs
  const techStack = [
  ...
  const projects = [
    {
      title: "TripHub",
      subtitle: "Collaborative Travel Platform",
      tech: ["MERN", "WebSockets", "GroqAI"],
      description: "A collaborative trip planning platform allowing groups to coordinate travel, split expenses, and chat in real-time.",
      features: [
        "Shared itineraries & real-time chat",
        "Budget management & expense splitting",
        "AI-driven travel recommendations"
      ],
      github: "https://github.com/AaryaAgrawal6105/TripHub",
      demo: "https://triphub-frontend.onrender.com/"
    },
    {
      title: "Flight Booking Backend",
      subtitle: "Enterprise Microservices Architecture",
      tech: ["Node.js", "MySQL", "RabbitMQ"],
      description: "A scalable backend system for flight bookings, built with microservices and message queues for high availability.",
      features: [
        "User authentication & role management",
        "Flight search, booking, and payment integration",
        "Event-driven communication using RabbitMQ"
      ],
      github: "https://github.com/AaryaAgrawal6105/FlightsAndSearchService"
    },
    {
      title: "QuickChat",
      subtitle: "Real-time Communication App",
      tech: ["MERN", "Socket.IO", "Cloudinary"],
      description: "A real-time chat application supporting image uploads, notifications, and group messaging.",
      features: [
        "1:1 and group chat functionality",
        "Typing indicators & message notifications",
        "Media uploads with Cloudinary"
      ],
      github: "https://github.com/AaryaAgrawal6105/QuickChat",
      demo: "https://quickchat-kxkd.onrender.com/login"
    }
  ];
    ...
    <div className="bg-slate-900 text-slate-300 font-sans antialiased">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden lg:flex items-center space-x-1">
              {['home', 'about', 'skills', 'projects', 'contact'].map((item) => (
                <button
                  ...
                  className={`capitalize px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200 ${activeSection === item ? 'bg-slate-700 text-white' : 'text-slate-400 hover:text-white'
                    }`}
                >
                  {item}
                </button>
            ...
            <div className="flex items-center">
              <button
                ...
                className="hidden sm:inline-flex items-center gap-2 bg-slate-800/50 border border-slate-700 hover:bg-slate-700 text-slate-300 hover:text-white focus:ring-slate-500 px-4 py-2 text-sm rounded-lg font-semibold transition-colors"
              >
                <Download size={16} />
                <span>Resume</span>
              </button>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="fixed top-0 right-0 w-64 h-full bg-slate-900 border-l border-slate-800 p-6">
            <div className="flex justify-between items-center mb-8">
              <span className="text-lg font-bold text-white">Menu</span>
              <button onClick={() => setMobileMenuOpen(false)} className="p-2 hover:bg-slate-800 rounded-md">
                <X size={20} />
              </button>
            </div>
            <nav className="space-y-4">
              {['home', 'about', 'skills', 'projects', 'contact'].map((item) => (
                <button
                  key={item}
                  onClick={() => scrollToSection(item)}
                  className="block w-full text-left capitalize px-3 py-2 rounded-md text-slate-400 hover:text-white hover:bg-slate-800 transition-colors"
                >
                  {item}
                </button>
              ))}
      ...
      <main className="relative z-10">
        {/* Home Section */}
        <section id="home" className="min-h-screen flex items-center pt-16 py-24 sm:py-32">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-slate-100 to-slate-400 mb-4">
              Aarya Piyush Agrawal
            </h1>
            ...
            <p className="max-w-3xl mx-auto text-lg text-slate-400 leading-relaxed mb-12">
              I build scalable, efficient, and beautiful web applications. Currently pursuing my B.E. in Information Technology at PICT, Pune.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <a
                href="mailto:aarya6105@gmail.com"
                className="font-semibold transition-all duration-300 active:scale-95 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900 inline-flex items-center justify-center gap-2 bg-sky-500 hover:bg-sky-600 text-white shadow-lg focus:ring-sky-500 px-6 py-3 text-lg rounded-xl"
              >
                <Mail size={18} /> Get In Touch
              </a>
              <button
                onClick={handleResumeDownload}
                className="font-semibold transition-all duration-300 active:scale-95 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900 inline-flex items-center justify-center gap-2 bg-slate-700/50 border border-slate-700 hover:bg-slate-700 text-slate-300 hover:text-white focus:ring-slate-500 px-6 py-3 text-lg rounded-xl"
              >
        ...
        <section id="about" className="py-24 sm:py-32">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="space-y-6 text-slate-300 text-lg leading-loose">
              <p>
                As a dedicated Full Stack Developer, I'm driven by a passion for not just writing code, but building solutions that are a joy to use. My journey in technology, currently centered at the{' '}
                <span className="text-sky-400 font-semibold">Pune Institute of Computer Technology</span>, is defined by a relentless pursuit of knowledge and excellence, reflected in my{' '}
                <Badge>9.75 CGPA</Badge>.
              </p>
              <p>
                I specialize in the <Badge>MERN Stack</Badge> and architecting <Badge>Microservices</Badge>, focusing on creating systems that are as scalable and robust as they are user-friendly. Beyond the screen, my time on the cricket field and volunteering at tech festivals has taught me the value of teamwork, discipline, and community—principles I bring to every project I undertake.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* Skills Section */}
        <section id="skills" className="py-24 sm:py-32 bg-slate-900/70">
            <SectionHeader title="Technical Toolkit" />
            <div className="flex flex-wrap justify-center gap-x-6 gap-y-10">
              {techStack.map(tech => {
                const LogoComponent = logos[tech.name.toLowerCase()]; // lookup logo component

                return (
                  <div key={tech.name} className="group flex flex-col items-center gap-3 text-center w-28">
                    <div className="w-24 h-24 p-4 bg-slate-800 border border-slate-700 rounded-full group-hover:border-sky-500/50 group-hover:bg-slate-700/50 transition-all duration-300 flex items-center justify-center">
                      <div
                        className="w-12 h-12 rounded-full flex items-center justify-center"
                        style={{ backgroundColor: tech.color }}
                      >
                        {LogoComponent ? <LogoComponent width={24} height={24} /> : tech.name.slice(0, 2).toUpperCase()}
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4 pt-2">
                      {project.demo && (
                        <a
                          ...
                          className="font-semibold transition-all duration-300 active:scale-95 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900 inline-flex items-center justify-center gap-2 bg-sky-500 hover:bg-sky-600 text-white shadow-lg focus:ring-sky-500 px-5 py-2.5 text-base rounded-lg"
                        >
                      ...
                      {project.github && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="font-semibold transition-all duration-300 active:scale-95 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900 inline-flex items-center justify-center gap-2 bg-slate-700/50 border border-slate-700 hover:bg-slate-700 text-slate-300 hover:text-white focus:ring-slate-500 px-5 py-2.5 text-base rounded-lg"
                        >
        ...
        {/* Contact Section */}
        <section id="contact" className="py-24 sm:py-32 bg-slate-900/70">
            ...
            <div className="max-w-lg mx-auto">
              <form onSubmit={handleFormSubmit} className="space-y-6 bg-slate-800/30 border border-slate-800 rounded-2xl p-8">
                <p className="text-center text-slate-400">
                  Have a project in mind or just want to say hello? I'd love to hear from you. Fill out the form or email me directly.
                </p>
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-slate-800 border border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500 transition-all"
                    required
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2 bg-slate-800 border border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500 resize-none transition-all"
                    required
                  />
                </div>
                <button
                  type="submit"
                  className="w-full font-semibold transition-all duration-300 active:scale-95 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900 inline-flex items-center justify-center gap-2 bg-sky-500 hover:bg-sky-600 text-white shadow-lg focus:ring-sky-500 px-6 py-3 text-lg rounded-xl disabled:opacity-70 disabled:cursor-not-allowed"
              ...
              <div className="text-center mt-8">
                ...
                <a href="mailto:aarya6105@gmail.com" className="text-sky-400 hover:text-sky-300 text-lg font-medium transition-colors">
                  aarya6105@gmail.com
                </a>
              </div>
            </div>
      ...
      <footer className="py-12 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-slate-500">
          <div className="flex justify-center gap-6 mb-8">
            <a href="https://github.com/AaryaAgrawal6105" target="_blank" rel="noopener noreferrer" className="hover:text-sky-400 transition-colors">
              <Github size={24} />
            </a>
            <a href="https://linkedin.com/in/aarya6105" target="_blank" rel="noopener noreferrer" className="hover:text-sky-400 transition-colors">
              <Linkedin size={24} />
            </a>
            <a href="mailto:aarya6105@gmail.com" className="hover:text-sky-400 transition-colors">
              <Mail size={24} />
            </a>
          </div>
      ...
      {showScrollTop && (
        <button
          ...
          className="fixed bottom-5 right-5 z-50 w-10 h-10 bg-sky-500/20 backdrop-blur-sm border border-sky-500/30 text-sky-400 hover:bg-sky-500/30 rounded-full flex items-center justify-center transition-all duration-300"
        >
          <ArrowUp size={20} />
        </button>
      )}
